 ...
 * Objects: reqList, reqCheck, startTime;
 * requestList类的getReqList方法得到请求队列中已有请求
 * requestList类的submitReq方法向请求队列中提交请求
 * invariant: !((reqList==null||reqCheck==null||!((Object)startTime instanceof Long))||
 * 				(\exist int i;0<=i<reqList.size();(req==null||!(req instanceof request))))
 */

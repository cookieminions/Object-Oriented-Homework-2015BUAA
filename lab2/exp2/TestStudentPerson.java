...
public class TestStudentPerson {
	public static void main(String[] args)
	{
		...
		((Student)person[0]).register();//学生注册
	    ((Student)person[0]).updateAge(23);//更新该生的年龄
	    person[0].toString();//打印输出
	    
	    
	    person[1]=new Student("Kate",'F',21,"201504135147","061502");//添加一条学生信息
	    ...
	    ((Teacher)person[2]).register();//完成教师的注册，记录注册时间并设定基本薪资
	    person[2].toString();
	    
	    person[3]=new Teacher("Jason",'M',41,"07","01453");//添加一条教师信息

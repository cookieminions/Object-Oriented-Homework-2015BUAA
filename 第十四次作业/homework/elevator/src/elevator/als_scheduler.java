...
/* Overview: new_scheduler 类继承了父类保存的电梯系统内的电梯和系统时间以及请求迭代量，同时还保存了需要进行捎带需要的主请求 主楼层 临时方向和捎带队列等信息，负责将请求队列中的请求取出并分配给电梯 在电梯运行过程中对可捎带的请求再进行分配 并忽略相同请求

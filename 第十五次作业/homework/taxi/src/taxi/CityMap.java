...
public class CityMap extends Thread{
	...
	public void setOpen(int i1,int j1,int i2,int j2) {
		/*
		  @MODIFIES: cityMap;
		  @EFFECTS: ((i1,j1)和(i2,j2)都在地图内 && (i1,j1)和(i2,j2)在最初地图上不是断开的 && (i1,j1)和(i2,j2)相邻 && (i1,j1)和(i2,j2)之间是断开的) ==> Open((i1,j1),(i2,j2));
		  */
		...
		if(cityMap[i1][j1].getFlow(cityMap[i2][j2])==999999){
			System.out.println("("+i1+","+j1+") and ("+i2+","+j2+") setOpen wrong");
			return;
		}
